...
export const RPC_ENDPOINT = import.meta.env.VITE_RPC_ENDPOINT ?? 'https://mainnet.helius-rpc.com/?api-key=9fa092b1-7284-4f3a-9cc9-648dfab32cf3'

// Solana address that will receive fees when somebody plays on this platform
export const PLATFORM_CREATOR_ADDRESS = new PublicKey(
  'F7j7rKs8bwuJB551QPpiinDnvPN5zGcXiPtR916xWh9L'
)
